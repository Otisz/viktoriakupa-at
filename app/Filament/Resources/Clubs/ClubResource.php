...
use App\Filament\Resources\Clubs\Pages\ListClub;
...
class ClubResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Egyesület';

    protected static ?string $pluralModelLabel = 'Egyesületek';
